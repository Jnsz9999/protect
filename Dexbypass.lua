...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Jnsz9999/protect/main/CloneRefDex.lua", true))()

-- Dex Bypasses
loadstring(game:HttpGet("https://raw.githubusercontent.com/Jnsz9999/protect/main/BypassDexS.lua", true))()
